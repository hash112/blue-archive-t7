...
{
	var_63eba41d = array(getweapon("t6_m27_up"), getweapon("t6_death_machine_up"), getweapon("iw4_desert_eagle_up"));
	var_43f586fe = array(getweapon("pistol_c96_upgraded"), getweapon("ar_marksman_upgraded"), getweapon("shotgun_pump_upgraded"));
