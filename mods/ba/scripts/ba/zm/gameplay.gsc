...
#using scripts\ba\zm\perkplus;
#using scripts\ba\zm\t8_perkloss;
#using scripts\ba\zm\magicboxshare;
#using scripts\ba\zm\mule_kick_indicator;
#using scripts\ba\zm\mule_kick_return;
#using scripts\ba\zm\zm_bot;
#using scripts\ba\zm\zm_counter;
#using scripts\ba\zm\zm_sub;
#using scripts\ba\zm\coldwar_scoreevent;
#using scripts\ba\zm\_aae_zombie_health_bar;

#using scripts\ba\_chat_notify;
#using scripts\ba\clientsystem;
#using scripts\ba\core_util;
#using scripts\ba\thirdperson;
...
#precache( "eventstring", "ba_cheats_notification" );
#precache( "eventstring", "ba_mobchan_zombies_notification" );
...
function opening_notifications_think()
{
    ...
    if ( GetDvarInt("tfoption_mobchan_zombie", 0) )
    {
        wait(interval);
        self LUINotifyEvent( &"ba_mobchan_zombies_notification", 0 );
    }
    ...
    if ( core_util::is_cheats_enabled(false) )
    {
        ...
        wait(interval);
        self LUINotifyEvent( &"ba_cheats_notification", 0 );
    }
}
