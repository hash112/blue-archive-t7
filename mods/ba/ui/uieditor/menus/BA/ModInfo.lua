...
DataSources.ModInfoUsefulLinks = DataSourceHelpers.ListSetup("ModInfoUsefulLinks", function(f26_arg0)
    ...
    table.insert(f26_local0, {
        models = {
            label = "BA_MENU_WORKSHOP",
            description = "",
            url = "https://steamcommunity.com/sharedfiles/filedetails/?id=3302644889",
    ...
    table.insert(f26_local0, {
        models = {
            label = "Github Repo",
            description = "",
            url = "https://github.com/hash112/blue-archive-t7",
            widgetType = "navbutton"
        },
        properties = CoD.TFPCUtil.OptionsUrlButtonProperties
    })
    ...
    table.insert(f26_local0, {
        models = {
            label = "Twitter",
            description = "",
            url = "https://twitter.com/hash_cpp",
            widgetType = "navbutton"
        },
        properties = CoD.TFPCUtil.OptionsUrlButtonProperties
    })
...
DataSources.ModInfoFAQ = DataSourceHelpers.ListSetup("ModInfoFAQ", function(f26_arg0)
    ...
    table.insert(f26_local0, {
        models = {
            label = "BA_MODINFO_FAQ_EYES_BAD_RENDER",
            description = "BA_MODINFO_FAQ_EYES_BAD_RENDER_DESC",
            widgetType = "navbutton"
        },
    ...
    table.insert(f26_local0, {
        models = {
            label = "BA_MODINFO_FAQ_SAVE_RESET",
            description = "BA_MODINFO_FAQ_SAVE_RESET_DESC",
            widgetType = "navbutton"
        },
        properties = CoD.TFPCUtil.OptionsEmptyButtonProperties
    })
    table.insert(f26_local0, {
        models = {
            label = "BA_MODINFO_FAQ_CUSTOM_MAPS",
            description = "BA_MODINFO_FAQ_CUSTOM_MAPS_DESC",
    ...
    -- table.insert(f26_local0, {
    --     models = {
    --         label = "BA_MODINFO_FAQ_CP_LOADING",
    --         description = "BA_MODINFO_FAQ_CP_LOADING_DESC",
    --         widgetType = "navbutton"
    --     },
    --     properties = CoD.TFPCUtil.OptionsEmptyButtonProperties
    -- })
    table.insert(f26_local0, {
        models = {
            label = "BA_MODINFO_FAQ_CHAT_CMD",
            description = "BA_MODINFO_FAQ_CHAT_CMD_DESC",
            widgetType = "navbutton"
        },
        properties = CoD.TFPCUtil.OptionsEmptyButtonProperties
    })
...
LUI.createMenu.ModInfo = function(InstanceRef)
    ...
    f31_local3.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("BA_MODINFO_TITLE"))
