...
CoD.StartMenu_GameOptions_ZM.new = function ( menu, controller )
	...
	Shortcuts:setText( Engine.Localize( "BA_ZM_SHORTCUTS_DESC" ) )
	...
	Shortcuts2:setText( Engine.Localize( "BA_ZM_SHORTCUTS" ) )
